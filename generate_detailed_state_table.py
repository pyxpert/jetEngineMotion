...
def generate_motor_positions_and_states():
    """
    生成机器人运动过程中的详细状态表
    """
    # 机器人参数
...
# 生成状态列表
states_list = generate_motor_positions_and_states()

# 写入详细状态表到文件
with open('robot_detailed_state_table.txt', 'w', encoding='utf-8') as f:
    f.write('"""机器人运动状态详细记录表\n')
